...
![Печатная форма документа Реализации](screenshots/ПечатнаяФормаРеализации.png)
![Отчет по начислению зарплаты](screenshots/ОтчетНачислениеЗарплаты.png)
![Пример кода документа НачислениеЗарплаты](screenshots/КодДокументаНачисления.png)
![Пример кода HTTP-сервиса для записи документа из мобильного приложения](screenshots/HTTPсервисЗаказ.png)
